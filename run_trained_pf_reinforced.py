    ...
    def test(model, test_loader):
        ...
        for index, data in enumerate(test_loader):
            ...
            if index == 0:
                ...
                ground_truth = np.concatenate((ground_truth, test_data))
                point_pred = np.concatenate((point_pred, input_data))
            ...
            distance[index] = calculate_dist(test_data, synth)

        GLOW_pred_dict = {}
        GLOW_pred_dict['median_pred'] = median_pred
        GLOW_pred_dict['ground_truth'] = ground_truth
        GLOW_pred_dict['point_pred'] = point_pred
